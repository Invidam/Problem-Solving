...
Good
1. 구상을 하여 구현한거 자체로 잘하였다. 정답률이 낮음에도 불구하고.
2. 그리디와 배운 것들을 잘 응용하였다.
3. 시간이 오래걸렸지만 끝까지 포기X, 풀었다.

Bad
1. ll 사용 이유를 몰라서 몇 번 지체되었다.
int max	2^31-1	2^9쯤
ll max	2^63-1	2^18쯤 인 것을 기억하자.
2. 구상을 8개로 나눴는데 4개로 했어도 되었을듯하다. 
3. 코드가 너무 복잡해졌다. 함수 리턴을 이용하는게  시간복잡도는 줄어도 보기가 복잡해 푸는 시간가 늘어남.
