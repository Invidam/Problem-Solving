...
Good
1. dp, 메모이제이션에 대해 직접 경험함
2. 용량 줄이는 참신하게 짰는데 시간초과가 됐다. 왜그럴가 ;;
3. 

Bad
1. 메모이제이션을 사용할 때, 재귀 처리의 조건(입력 인자)와 같은 배열을 선언해야 한다. [이 부분에 대해 용량을 줄이기 위해 다르게 작성하였는데 그것 때문에 시간초과가 되는 듯].
